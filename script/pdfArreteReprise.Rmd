...
ind <- grep("ARTICLE 10|ARTICLE 11| ARTICLE [4-6]", df$article1)
ind <- grep("ARTICLE [4-9]", df$article1)
df <- df [-ind,]
...
for (f in ficPDF){
  ...
  for (i in c(1: length(tmp$deb))){
      ...
      output =  paste0("../data/pdf/arrete_2025_",numArr, doublon,".pdf"), )
  }
