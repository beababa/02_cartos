...
choroLayer(equipot, var = "center", 
           ...
           lwd = .2, 
           legend.pos = "topright", 
           legend.title.txt = "densité réponses oui",
           legend.horiz = FALSE,
           add = TRUE)
layoutLayer(title = "Concentration des réponses validant un dégât en région Centre Val de Loire", 
            theme = "red.pal",
...
carte plus classique

```{r}
summary(jointuresf$reponse)
png("../img/choro.png")
par(mar = c(0, 0, 1.2, 0))
mypal <- carto.pal(pal1 = "green.pal", n1 = 1, pal2 = "wine.pal", n2 = 4)
ghostLayer(regionS$geom, bg = "lightblue2")
plot(region$geom, col = "antiquewhite1", border = "grey", add = TRUE)
choroLayer(jointuresf, var = "reponse", 
           breaks = c(-2, 0,2,4,8,10), 
           col = mypal,
           border = "#121725", 
           lwd = .2, 
           legend.pos = "topright", 
           legend.title.txt = "différence oui non",
           legend.horiz = FALSE,
           add = TRUE)
layoutLayer(title = "Réponses validant un dégât en région Centre Val de Loire", 
            theme = "red.pal",
            sources = "Arvalis,2021",
            horiz = FALSE, 
            postitle = "center", 
