...
reprise fichiers bâtiments du site web POI
...
```{r}
rues <- st_read(paste0(chemin,"08_VOIRIE/voirie.gpkg"), "couche_regroupe")
rues <- st_transform(rues, 4326)
