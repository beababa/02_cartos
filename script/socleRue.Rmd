...
```{r}
rue$NOM_1_G[!is.na(rue$NOMnumero)] <- rue$NOMnumero [!is.na(rue$NOMnumero)] 
rue$NOM_1_G[!is.na(rue$NOMnumero)] 
motif <- c("ALL |^R |SEN |IMP ")
rue$NOM [!is.na(rue$NOMnumero)] <- gsub(motif, "", rue$NOM [!is.na(rue$NOMnumero)])
```
