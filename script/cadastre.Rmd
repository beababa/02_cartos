...
cadastre <- st_read(paste0(chemin,"/03_SOCLE/cadastre2022.sqlite"), "parcelle_info")
str(cadastre)
...
st_write(cadastre, "../data/cadastre.gpkg", "proprio", delete_layer = T)
```
