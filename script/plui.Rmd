...
le cadastre est issu des couches de sqlite cadastre2022
...
Du coup, on mesure les aires... 12 anomalies
...
Sur géorique, au départ 19 ICPE (Installations classées pour la protection de l'environnement (ICPE) soumises à autorisation ou à enregistrement (en fonctionnement ou en cessation d'activité))
...
Donc BIONAZ CEMEXBETON et EQUIIOM BETON sont en plus.
