...
Mais il faut sauvegarder l'indiex
...
## Combien de pages par .pdf ?



```{r}
#### présentation des élémnents####
# liste des noms d'arrete indexe 1 à 140
numModif
# DONC CPTEUR iOLD 1 140
# liste des 10 fichiers avec nb pages différentes
ficPDF
# pagination des 61 arretes
pagination
# donc CPT num 1 61 ms inutile car f
...
i <- 1
iOLD <- 1
# iNum index du nom de l'arrete,  
iArr <- 1
for (f in ficPDF){
  nbP <- nbPages [f]
  print(nbP)
  iArr <- 1 
  deb <- pagination$deb [iArr]
  fin <- pagination$fin [iArr]
  numArr <- numModif [deb]
