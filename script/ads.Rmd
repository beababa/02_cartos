...
# 410 seulement 
# repérage des lg où chiffre 3-9
ind1 <- grep(" [3-9] ",registre$nature.des.travaux.envisagés [ind], value = F)
# 135 obs...
# indice de la position des chiffres
ind2 <- regexpr("[3-9]", registre$nature.des.travaux.envisagés [ind1] )
# extraction du nb et transformation en entier (il y a une virgule qui traine)
tmp$nb  <- substring(tmp$nature.des.travaux.envisagés, ind2, ind2+1)
tmp$nb <- as.integer(gsub(" |,", "", tmp$nb))
