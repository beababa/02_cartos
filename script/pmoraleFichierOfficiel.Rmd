...
```{r}
data <- read.csv2(paste0(chemin,"02_URBA/PM_21_NB_930.txt"), fileEncoding = "latin3")
...
mf_layout("première exploration Personne morale opendata", "source : cadastre 2022 & personne morale 2021")
```
