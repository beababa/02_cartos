...
rue <-  st_read( paste0(chemin,"bondy.gpkg"), "ruePrincipale", quiet = TRUE)
...
barplot(table(densite), main = "Nb d'adresses par carreau 200*200", xlab = "Nb d'adresses", ylab = "Occurences")
...
mf_layout(title = "152 lignes géocodées de l'inventaire social" )
```
