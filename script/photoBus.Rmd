...
Il manque la photo 31 (récupéré)
...
# 2 pts perdus 67 et 72 = à quoi correspondent ces points ?
...
```{r}
names(joint)
st_write(joint [, c("name", "plan", "Adresse", "terrain", "chemin")],"../data/mobPublicitaire.gpkg", "terrain bus", append = F)
```
...
```{r}
joint$chemin <- paste0("bus/", joint$plan, ".jpg" )
```
