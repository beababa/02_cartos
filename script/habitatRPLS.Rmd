...
verif <- function(fic) {
  ...
  # on suppose que le nom voie sera tjrs en 2e position 19e pour 2024
  ind <- names(fic)[ind]
...
mf_export(rpls, width = 1000, height = 1000, res = 100, filename = "../img/RPLS2024.png", expandBB = c(10,10,30,10))
mf_init(rpls)
mf_theme("candy")
...
#mf_inset_off()
mf_layout(title = "RPLS 2024, nombre d'étages", 
