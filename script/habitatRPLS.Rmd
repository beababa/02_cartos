...
# creation de la clé
cle <- grep("voie", names(fic))
fic$cle <- paste0(fic [,cle[1]], fic [,cle[2]], fic [,cle[3]])
# agg etage
...
geo <- unique( fic [,c("cle", "Nom.du.Programme",  "Année.de.construction" ,"Coordonnée.X", "Coordonnée.Y") ])
